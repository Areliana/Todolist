...
// save the task text and completion status in local storage
  ...
  confetti(Object.assign({}, defaults, opts, { particleCount: Math.floor(count * particleRatio) }));
    ...
    const interval = setInterval(() => {
       fire(.2, { spread: 60, startVelocity: 30, scalar: 0.8, origin: {y}});
       fire(.1, {spread: 120, startVelocity: 55, scalar: 1.2 });
       y -= 0.5;
